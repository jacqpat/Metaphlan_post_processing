...
def main():
    ...
    parser.add_option('-x', '--index', dest='index_column', default='Sample', action='store', help='Name of the column used as an index')
    parser.add_option('-z', '--elements', dest='index_elements', default='Site', action='store', help='Name of the column used to color the samples')
